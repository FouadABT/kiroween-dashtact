              ...
              <div className="space-y-4">
                ...
                <div className="border-l-4 border-primary pl-4">
                  ...
                  <ol className="space-y-1 text-sm text-muted-foreground list-decimal ml-4">
                    ...
                    <li>Load user's permissions from database (cached)</li>
                ...
                <div className="border-l-4 border-primary pl-4">
                  ...
                  <ol className="space-y-1 text-sm text-muted-foreground list-decimal ml-4">
                    ...
                    <li>Check user's notification preferences</li>
                ...
                <div className="border-l-4 border-primary pl-4">
                  ...
                  <ol className="space-y-1 text-sm text-muted-foreground list-decimal ml-4">
                    ...
                    <li>Apply theme to user's session</li>
          ...
          <Card>
            ...
            <CardContent>
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li>• <strong>XSS Protection:</strong> React&apos;s built-in escaping + CSP headers</li>
