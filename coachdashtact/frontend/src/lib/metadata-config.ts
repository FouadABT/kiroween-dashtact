...
export const metadataConfig: Record<string, PageMetadata> = {
  ...
  '/member': {
    ...
    description: 'Your coaching dashboard - view sessions, book appointments, and manage your profile',
    keywords: ['member', 'coaching', 'dashboard', 'sessions'],
    breadcrumb: { label: 'Member Portal' },
    openGraph: {
      title: 'Member Dashboard',
      description: 'Access your coaching dashboard with sessions and appointments',
      type: 'website',
    },
    twitter: {
      title: 'Member Dashboard',
  ...
  '/member/sessions': {
    ...
    keywords: ['sessions', 'coaching', 'appointments', 'schedule'],
    breadcrumb: { label: 'My Sessions' },
    robots: {
      index: false,
      follow: true,
      noarchive: true,
  ...
  '/member/sessions/:id': {
    ...
    description: 'View session details and provide feedback',
    keywords: ['session', 'details', 'coaching'],
    breadcrumb: { label: 'Session Details', dynamic: true },
    robots: {
      index: false,
      follow: false,
      noarchive: true,
  ...
  '/member/book-session': {
    ...
    description: 'Schedule a coaching session with your coach',
    keywords: ['book', 'session', 'schedule', 'appointment', 'coaching'],
    breadcrumb: { label: 'Book Session' },
    robots: {
      index: false,
      follow: true,
      noarchive: true,
  ...
  '/member/profile': {
    title: 'My Profile',
    description: 'Manage your member profile and coaching goals',
    keywords: ['profile', 'member', 'goals', 'coaching'],
  ...
  '/member-signup': {
    ...
    description: 'Join as a member and start your coaching journey',
    keywords: ['signup', 'member', 'register', 'coaching'],
    breadcrumb: { label: 'Member Sign Up' },
    robots: {
      index: false,
      follow: false,
      noarchive: true,
  ...
  // Dashboard Member Portal pages (alternative routes)
  '/dashboard/member': {
    title: 'Member Dashboard',
    description: 'Your coaching dashboard - view sessions, book appointments, and manage your profile',
    keywords: ['member', 'coaching', 'dashboard', 'sessions'],
  ...
  '/dashboard/member/messages': {
    title: 'Messages',
    description: 'Chat with your coach and manage conversations',
    keywords: ['messages', 'chat', 'coaching', 'communication', 'conversations'],
  ...
  '/dashboard/coaching/messages': {
    title: 'Messages',
    description: 'Chat with your members and manage conversations',
    keywords: ['messages', 'chat', 'coaching', 'communication', 'conversations'],
    breadcrumb: { label: 'Messages' },
    robots: {
      index: false,
  ...
  // Coaching Platform pages
  '/dashboard/coaching': {
    title: 'Coaching Dashboard',
    description: 'Manage your coaching sessions and members',
    keywords: ['coaching', 'dashboard', 'sessions', 'members', 'management'],
    breadcrumb: { label: 'Coaching' },
    openGraph: {
      title: 'Coaching Dashboard',
      description: 'Comprehensive coaching management with sessions and member tracking',
      type: 'website',
    },
    twitter: {
      title: 'Coaching Dashboard',
  ...
  '/dashboard/coaching/members': {
    title: 'Members',
    description: 'Manage your coaching members',
    keywords: ['coaching', 'members', 'management', 'clients'],
  ...
  '/dashboard/coaching/members/:id': {
    title: 'Member: {userName}',
    description: 'View and manage member details',
    keywords: ['coaching', 'member', 'profile', 'details'],
    breadcrumb: { label: '{userName}', dynamic: true },
    robots: {
      index: false,
      follow: false,
  ...
  '/dashboard/coaching/sessions': {
    title: 'Sessions',
    description: 'View and manage coaching sessions',
    keywords: ['coaching', 'sessions', 'schedule', 'appointments'],
    breadcrumb: { label: 'Sessions' },
    openGraph: {
      title: 'Coaching Sessions',
      description: 'Manage your coaching sessions and schedule',
      type: 'website',
    },
    twitter: {
      title: 'Coaching Sessions',
  ...
  '/dashboard/coaching/sessions/:id': {
    title: 'Session Details',
    description: 'View session details and manage session',
    keywords: ['coaching', 'session', 'details'],
    breadcrumb: { label: 'Session Details', dynamic: true },
    robots: {
      index: false,
      follow: false,
  ...
  '/dashboard/coaching/availability': {
    title: 'Manage Availability',
    description: 'Set your coaching availability schedule',
    keywords: ['coaching', 'availability', 'schedule', 'calendar'],
