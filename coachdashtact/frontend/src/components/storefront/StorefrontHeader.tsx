      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex h-16 items-center justify-between gap-4">
          ...
          <nav className="hidden lg:flex items-center gap-8">
            ...
            <Link href="/shop?isFeatured=true" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
              Featured
            </Link>
            <Link href="/shop?inStock=true" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
              In Stock
            </Link>
          </nav>
