 ...
 * Excerpt Utilities
 * 
 * Frontend utilities for working with blog post excerpts.
 * Provides functions for stripping markdown and generating excerpts.
 */
...
/**
 * Get excerpt preview with metadata
 * 
 * Returns a preview of what the auto-generated excerpt would look like
 * along with metadata about the excerpt.
 * 
 * @param content - Blog post content
 * @param maxLength - Maximum character length
 * @returns Preview object with excerpt and metadata
 */
export function getExcerptPreview(
  ...
  return {
    ...
    isTruncated: plainText.length > maxLength,
  };
}
